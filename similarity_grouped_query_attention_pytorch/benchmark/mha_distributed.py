...
def main(rank:int,world_size:int,run,dataset_name,kv_heads,weight_flag,logging_name,if_random,weight_row_column,port):
...
if __name__ == "__main__":
    ...
    torch.multiprocessing.spawn(main, args=(world_size,run,dataset_name,kv_heads,weight_flag,dataset_name+"_"+logging_name.upper(),if_random,weight_row_column,port), nprocs=world_size, join=True)
