...
from minmaxgqa import convert_t5_to_mgqa
...
def train(
    ...
    t5 = convert_t5_to_mgqa(t5, kv_heads=4, inplace=False, min_flag=min_flag)
    ...
    tokenized_datasets_train = cnn_data_train.map(
        preprocess_function,
        batched=True,
